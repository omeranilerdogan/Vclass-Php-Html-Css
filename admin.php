            ...
            <div class="col-lg-12">
                <table class="table table-dark table-striped">
                  ...
                  foreach($dataList as $row){
                      ...
                      <td>
                      <a  href="admin.php?sil='.$row["yazi_id"].'" class="btn btn-danger">
                        SİL
                      </a>
                      </td>
                      <td>
                      <a href="güncelle.php?yazi_id='.$row["yazi_id"].'" class="btn btn-primary">
                        DÜZENLE
                      </a>
                      </td>
                  ...
                  <?php
                    if (isset ($_GET['sil'])) {
                      $verisil = $db->prepare(" DELETE FROM yaziler WHERE yazi_id=? ");
